...
while(True):
    ...
    pipatpong_image = face.load_image_file("pipatpong.png")
    pipatpong_face_encoding = face.face_encodings(pipatpong_image)[0]
    ...
    known_face_encodings = [pipatpong_face_encoding]
    known_face_names = ["pipatpong"]
